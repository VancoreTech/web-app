...
function Roles() {
  ...
  const applyFilters = () => {
    const filtered = rolesData.filter((role) => {
      return filter === "all" || role?.status?.toLowerCase() === filter;
    });
  ...
  const displayedRoles = filteredRoles.filter((role) =>
  ...
  const currentRoles = displayedRoles.slice(
    indexOfFirstProduct,
    indexOfLastProduct
  );
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-500">6 roles</p>
            </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      placeholder="Search for role name, ID etc.."
                      value={searchTerm}
                      onChange={(e) => {
