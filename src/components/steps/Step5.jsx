        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              onChange={(e) =>
                setFormData((prev) => ({ ...prev, storeUrl: e.target.value }))
              }
              ...
              required
            />
            <span className="absolute right-3 top-1/2 -translate-y-1/2 text-[15px] text-blue-600">
              .vancour.com
            </span>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-2.5">
            <label className="flex items-center h-11 px-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 flex-1 transition-all duration-200 bg-[#F6F8FA]">
              ...
              <div
                className={`ml-auto w-5 h-5 rounded-full border flex items-center justify-center transition-colors ${
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    hasPhysicalStore: e.target.value,
                  }))
                }
                className="sr-only"
              />
