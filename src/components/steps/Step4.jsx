...
export default function Step4({ goals, formData, onGoalToggle, onNext, isValid }) {
  const goalOptions = [
    ...
    <div className="max-w-4xl mx-auto px-3">
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        {goalOptions.map((goal, index) => {
          ...
          const isFullWidth = goal === "Manage my inventory and staff across different locations" || 
          ...
          return (
            <div key={index} className={`${isFullWidth ? 'col-span-2' : ''}`}>
              ...
              >
                ...
                <div className={`shrink-0 w-5 h-5 rounded border flex items-center justify-center transition-colors mx-3 ${
                  isSelected 
