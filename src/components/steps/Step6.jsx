  ...
  return (
    <div className="max-w-[380px] mx-auto px-3">
      ...
      <p className="text-gray-600 mb-4 text-center text-sm">
        Create your unique sign in password
      </p>
