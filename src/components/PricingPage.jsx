      ...
      <div className="px-4 py-8">
        <div className="max-w-[1200px] mx-auto">
          <div className="mb-12">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-1 lg:text-left text-center">
              Subscription plan
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-[#F8F9FF] rounded-xl p-6 shadow-sm transition-all duration-300 hover:shadow-lg hover:scale-[1.02]">
              ...
              <p className="text-gray-600 text-sm mb-6">
                Take control of your business finances with the Basic plan—your
                all-in-one solution for smart financial management.
              </p>
              <div className="mb-4">
