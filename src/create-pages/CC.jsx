  ...
  return (
    <div>
      ...
      <div className="py-10 px-7 relative">
        ...
        <form className="max-w-4xl mx-auto p-6 mt-8 bg-white">
          <div className="mb-8">
          ...
          <div className="flex justify-end gap-4">
            <button className="px-10 py-2 text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">
              Cancel
            </button>
            <button className="px-10 py-2 text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors">
              Proceed
            </button>
          </div>
        </form>
